...
let string1 = "Hi";
let sumCodePoints = string1.charCodeAt(0) + string1.charCodeAt(1);
...
Expected Output:
codePointDifference: 16 // 'C' = 67, 't' = 116, |67 - 116| = 16 (The absolute value should be 49)
*/

let inputString3 = "Cat";
let index1 = 0;
let index2 = 2;
let codePointDifference = inputString3.charCodeAt(index1) - inputString3.charCodeAt(index2);
...
// Task 2
let hell = [72, 101, 108, 108];
let wordFromCodePoints = String.fromCharCode(hell[0]) + String.fromCharCode(hell[1]) +
  String.fromCharCode(hell[2]) + String.fromCharCode(hell[3]); // Your code here

// Task 3
let inputString2 = "Launch";
let codePointL = inputString2.charCodeAt(0);
let codePointH = inputString2.charCodeAt(5);
let swappedString = String.fromCharCode(codePointH) + inputString2.slice(1, 5) + String.fromCharCode(codePointL); // Your code here
